...
void runword() {
  ...
  push(10); push(tib_adr); Serial.print("  pushed.  ");
  dotS();
  Serial.println("   y   ");  Serial.println(" ");
  dumpRAM();
  Serial.println(" ");  Serial.println("  That was dumpRAM(); ");
  Serial.println(" ");
...
//  Serial.println("  place is possibly assigned to output of fn locate(); sweet.");
