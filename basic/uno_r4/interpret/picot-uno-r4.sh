...
if [ $# -lt 1 ]; then
    ...
    echo "Use:  ./picot-uno-r4.sh /dev/ttyACM0"
    exit 1
fi
...
echo "Good for forth-like interpreter July 2024"

picocom -e \\ -f n -p n -d 8 -b 115200  --imap lfcrlf --omap delbs,crlf --send-cmd "ascii-xfr -sn -l 195 -c 28" ${1}
